...
* [Credential Statuses](concepts/credential-statuses/readme.md)
  ...
  * [REST API](concepts/credential-statuses/rest-api/readme.md)
    * [Checking the status of a credential](concepts/credential-statuses/rest-api/check-status.md)
    * [Revoking a credential](concepts/credential-statuses/rest-api/revoke.md)
