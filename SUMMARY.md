...
* [Transition To The Community Stack](ssi-kit/transition-to-the-community-stack.md)
* [SSI Kit | Basics](ssi-kit/ssi-kit-or-basics/README.md)
  * [Overview](ssi-kit/ssi-kit-or-basics/overview.md)
  * [Functionality](ssi-kit/ssi-kit-or-basics/functionality.md)
  * [Components](ssi-kit/ssi-kit-or-basics/components.md)
* [SSI Kit](what-is-the-ssi-kit/ssi-kit/README.md)
  ...
  * [Self-Sovereign Identity (SSI)](ssi-kit/ssi-kit/what-is-ssi/README.md)
    * [SSI | Basics](ssi-kit/ssi-kit/what-is-ssi/ssi-or-basics.md)
    * [Technologies & Concepts](ssi-kit/ssi-kit/what-is-ssi/technologies-and-concepts/README.md)
      * [Registries](ssi-kit/ssi-kit/what-is-ssi/technologies-and-concepts/registries.md)
      * [Decentralised Identifiers (DIDs)](ssi-kit/ssi-kit/what-is-ssi/technologies-and-concepts/decentralised-identifiers-dids.md)
      * [Verifiable Credentials (VCs)](ssi-kit/ssi-kit/what-is-ssi/technologies-and-concepts/verifiable-credentials-vcs-and-verifiable-presentations-vps.md)
      * [Verifiable Presentations (VPs)](ssi-kit/ssi-kit/what-is-ssi/technologies-and-concepts/verifiable-presentations-vps.md)
      * [Data Exchange (Protocols)](ssi-kit/ssi-kit/what-is-ssi/technologies-and-concepts/data-exchange-protocols.md)
...
* [REST API](getting-started/rest-apis.md)
  ...
  * [Custodian API - For Holders](getting-started/rest-apis/custodian-api/readme.md)
    * [Key management](getting-started/rest-apis/custodian-api/key-management.md)
    * [Did management](getting-started/rest-apis/custodian-api/did-management.md)
    * [Credentials management](getting-started/rest-apis/custodian-api/credentials-management.md)
  * [Auditor API - For Verifiers](getting-started/rest-apis/auditor-api.md)
  * [Core API](getting-started/rest-apis/core-api/readme.md)
    * [Cryptographic keys](getting-started/rest-apis/core-api/cryptographic-keys.md)
    * [Decentralised-Identifiers](getting-started/rest-apis/core-api/decentralised-identifiers.md)
    * [Verifiable-Credentials](getting-started/rest-apis/core-api/verifiable-credentials.md)
...
* [Verification Policies](usage-examples/verifiable-credentials/verification-policies.md)
  ...
  * [Dynamic/Custom Policies](concepts/verification-policies/dynamic-policies/README.md)
...
* [Selective Disclosure](concepts/selective-disclosure/README.md)
  ...
  * [Verifying a SD-JWT Credential](concepts/selective-disclosure/verifying-a-sd-jwt-credential.md)
* [Credential Statuses](concepts/credential-statuses/readme.md)
  ...
  * [CLI](concepts/credential-statuses/cli/readme.md)
    * [Check the status of a credential](concepts/credential-statuses/cli/check-status.md)
    * [Revoke a credential](concepts/credential-statuses/cli/revoke.md)
* [DID Web](concepts/did-web.md)
* [Open Policy Agent (OPA)](usage-examples/open-policy-agent.md)
  * [Setup](usage-examples/open-policy-agent/configure-opa-engine.md)
