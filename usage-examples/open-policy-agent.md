...
See the [Dynamic Verification Policies](verifiable-credentials/verification-policies.md#dynamic-policies) section for a full example of verifying credentials with a Rego/OPA policy.