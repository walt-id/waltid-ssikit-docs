...
Refer to [**EBSI/ESSIF usage examples**](../usage-examples/usage-examples-1.md) for examples of using **SSI Kit command line interface** with the EBSI/ESSIF infrastructures.
